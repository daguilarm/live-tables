{{-- AlpineJS x-cloak not work propperty so... https://alpinejs.dev/directives/cloak --}}
<template x-if="true">
    <div
            ...
            <div class="relative rounded-xl border border-gray-200 shadow-lg bg-gray-50 p-4">
                ...
                <div class="flex mt-6 mb-6 px-4">
                    ...
                    <div class="ml-3">
                        <h1 class="text-xl font-medium text-gray-700">
                            @lang('live-tables::strings.delete.title')
                        </h1>
                    </div>
                </div>

                <div class="p-6 text-md bg-red-50 text-red-600 border-t border-b border-red-200">
                    <li>@lang('live-tables::strings.delete.message')</li>
                </div>
                ...
                <div class="flex justify-center mt-8 mb-4">
                    ...
                    >
                        ...
                        {{-- Button text --}}
                        <div>@lang('live-tables::strings.delete.button')</div>
                    </button>
                </div>
            </div>
        </div>
